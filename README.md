...
- **Git worktree isolation** — run agents in isolated repo copies; changes auto-committed to branches on completion, with configurable branch naming and hook behavior
